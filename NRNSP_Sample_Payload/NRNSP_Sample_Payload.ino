////////////////////////////////////////////////////////////////////////////////////////////////////
// NRNSP_Sample_Payload.ino
// Z Porter
// NanoRacks LLC
// 9-8-16
//
// Sample NanoLab payload for the NR-NSP that controls a series of LEDs to indicate the current 
// flight altitude. All example specific code is clearly marked as such in the comments, and should
// be removed or replaced by the relevant code for the developer's experiment. This sample code is
// provided as is by NanoRacks LLC to help customers develop flight code for their NR-NSP payloads
